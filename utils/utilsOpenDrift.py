...
def opendriftObj2gpuoceanObs(opendrift_obj, x0, x1,y0,y1, source_url, land_mask = None):
    """
...
def simulate_opendrift(source_url, lat, lon, 
    ...
    # else: 
    #     reader_norkyst.variable_mapping['x_sea_water_velocity'] = 'u'
    #     reader_norkyst.variable_mapping['y_sea_water_velocity'] = 'v'
    ...
    o.set_config('drift:advection_scheme', 'runge-kutta4') #Set to runge-kutta4, which is the same as Parcels. Default is euler. 
